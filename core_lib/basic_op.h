#ifndef __BASIC_OP__H
#define __BASIC_OP__H
#include "typedef.h"
...
#define F64 (uint64_t) 0xffffffffffffffffLL
...
Word16 roundB (Word32 L_var1);             /* Round,               1   */
...
Word16 div_l( Word32  L_num, Word16 den ); /*Long div,            20  */ 
